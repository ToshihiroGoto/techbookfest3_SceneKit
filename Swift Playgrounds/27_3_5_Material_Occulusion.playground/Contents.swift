...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<10 {
            ...
            geometry.firstMaterial?.ambientOcclusion.contents = UIImage(named: "check.png")
            geometry.firstMaterial?.ambientOcclusion.intensity = CGFloat(intensity * Float(i))
