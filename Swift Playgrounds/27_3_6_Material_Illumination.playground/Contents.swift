...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<10 {
            ...
            geometry.firstMaterial?.diffuse.contents = UIImage(named: "li1.png")
            geometry.firstMaterial?.selfIllumination.contents = UIImage(named: "li2.png")
            geometry.firstMaterial?.selfIllumination.intensity = CGFloat(intensity * Float(i))
